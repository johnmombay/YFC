...
namespace Admin.YFC.Controllers
{
	public class MinistryInfosController : Controller
	{
		...
		public async Task<IActionResult> GetMinistryInfos()
		{
			...
			return Json(new { data = ministryInfos });
		}
		...
		[HttpPost]
		public async Task<IActionResult> Create([Bind("MinistryId,About,Leaders,News,Calendar")] MinistryInfo ministryInfo)
		{
		...
		[HttpPost]
		public async Task<IActionResult> Edit(int id, [Bind("MinistryInfoId,MinistryId,About,Leaders,News,Calendar")] MinistryInfo ministryInfo)
		{
		...
		public async Task<IActionResult> Delete([Bind("MinistryInfoId,MinistryId,About,Leaders,News,Calendar")] MinistryInfo ministryInfo)
		{
